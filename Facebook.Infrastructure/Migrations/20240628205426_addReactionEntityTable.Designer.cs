...
namespace Facebook.Infrastructure.Migrations
{
    ...
    [Migration("20240628205426_addReactionEntityTable")]
    partial class addReactionEntityTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Facebook.Domain.Post.ReactionEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("e947b1e8-dd6f-496f-97ec-0b523e15f95f"),
                            Code = ":like:",
                            Emoji = "👍"
                        },
                        new
                        {
                            Id = new Guid("e96309a8-f13f-4714-ad6f-7b922e1cf42f"),
                            Code = ":love:",
                            Emoji = "❤️"
                        },
                        new
                        {
                            Id = new Guid("f76bb596-1600-476c-83c3-ee69c2c98b9a"),
                            Code = ":haha:",
                            Emoji = "🤣"
                        },
                        new
                        {
                            Id = new Guid("ed6cd369-0bfa-4822-9ea6-d3e789b4a4c5"),
                            Code = ":wow:",
                            Emoji = "😮"
                        },
                        new
                        {
                            Id = new Guid("277bf060-ef5e-4fe3-b19e-e6cba28d1bcb"),
                            Code = ":sad:",
                            Emoji = "😭"
                        },
                        new
                        {
                            Id = new Guid("9261147d-b5c3-4441-bbf6-44d8422ebdb3"),
                            Code = ":angry:",
                            Emoji = "🤬"
                        },
                        new
                        {
                            Id = new Guid("c4391285-e3df-4a78-8862-0ed1c3559f5a"),
                            Code = ":clown:",
                            Emoji = "🤡"
                        },
                        new
                        {
                            Id = new Guid("2fb18f6b-7483-4f4f-9348-1eca2dc333f2"),
                            Code = ":smart:",
                            Emoji = "🤓"
                        });
                });
            ...
            modelBuilder.Entity("PostEntityReactionEntity", b =>
                {
                    ...
                    b.ToTable("PostEntityReactionEntity");
                });
            ...
            modelBuilder.Entity("PostEntityReactionEntity", b =>
                {
                    b.HasOne("Facebook.Domain.Post.PostEntity", null)
                        .WithMany()
                        .HasForeignKey("PostsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Facebook.Domain.Post.ReactionEntity", null)
                        .WithMany()
